...
/*
 ...
 displayed on the screen. Go through the code and understand it. Put timers on it and see how long 
 it take to run with different values for N.
*/
...
{	
	...
	for(int i = 0; i < NUMSPHERES; i++)
	{
		...
		SpheresCPU[i].radius = MAXRADIUS*rand()/RAND_MAX;
	}
}	
